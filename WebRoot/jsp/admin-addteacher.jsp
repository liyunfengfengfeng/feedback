...
<body>
  ...
  <div class="ui main text container">
    <h1 class="ui header">添加教师</h1>
    <div class="ui= message">${error}${success}</div>
    <form class="ui large form" action="newteacher.do" method="post">
      <div class="ui warning form segment">
        <div class="field">
          <label>教师工号</label>
          <input placeholder="教师登录账号" name="account" type="text">
        </div>
        <div class="field">
          <label>教师姓名</label>
          <input placeholder="教师姓名" name="tea_name" type="text">
        </div>
        <div class="field">
        ...
        <div class="field">
          ...
          <select class="ui two dropdown" name="course">
          	<c:forEach items="${list}" var="data">
        	  	<option value="${data.id}">${data.cou_name}</option>
			</c:forEach>
          </select>
        </div>
        <div class="field">
