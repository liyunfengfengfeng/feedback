 ...
 <div class="ui fixed inverted menu">
  ...
  <div class="ui main text container">
    ...
    <div class="ui pagination menu">
	  <a class="icon item" href="allteacher.do?currpage=0">
	    	首页
	  </a>
	  <c:forEach var="x" begin="1" end="${list.total/list.size + 1}" step="1">
	  	<a class="active item" href="allteacher.do?currpage=${x-1}">
	      ${x}
	    </a>
	  </c:forEach>
	  <fmt:formatNumber var="c" value="${list.total/list.size}" pattern="#"/>
	  <a class="icon item" href="allteacher.do?currpage=${c}">
	    	尾页
	  </a>
	</div>
  </div>
